...
/*
 ...
 In order to ease the comparison, of a 112 bit string, we have the signature
 encoded as a series of uint64_t, uint32_t, uint16_t. It ends up like this:
 TLV:      0x12(Length 18 bytes) 0x3(Type: String)
 uint64_t: 0x4d(M) 0x0(\0) 0x53(S) 0x0(\0) 0x46(F) 0x0(\0) 0x54(T) 0x0(\0)
 uint32_t: 0x31(1) 0x0(NUL) 0x30(0) 0x0(NUL)
 uint16_t: 0x30(0) 0x0(NUL)
 Cookie:   0x4(Cookie) 0x0(NUL)
 Obviously, we also have to convert it to USB endianness.
*/

#define  MS_OS_SIGNATURE_REF_STRING_1  HostToUSB64(0x005400460053004dllu)
#define  MS_OS_SIGNATURE_REF_STRING_2  HostToUSB32(0x00300031lu)
#define  MS_OS_SIGNATURE_REF_STRING_3  HostToUSB16(0x0030u)
...
/*
 ...
 Warning, this is network order padded ASCII. Thus, the HostToUSB64 macro from
 the USB Stack is needed to avoid any endian conversion issues.
 
 */

#define   MS_OS_10_NULL_COMPATIBLE_ID    HostToUSB64(0x0000000000000000llu)
#define   MS_OS_10_RNDIS_COMPATIBLE_ID   HostToUSB64(0x524E444953000000llu)
#define   MS_OS_10_PTP_COMPATIBLE_ID     HostToUSB64(0x5054500000000000llu)
#define   MS_OS_10_MTP_COMPATIBLE_ID     HostToUSB64(0x4D54500000000000llu)
#define   MS_OS_10_XUSB20_COMPATIBLE_ID  HostToUSB64(0x5855534232300000llu)
#define   MS_OS_10_BLUTUTH_COMPATIBLE_ID HostToUSB64(0x424C555455544800llu)
#define   MS_OS_10_WINUSB_COMPATIBLE_ID  HostToUSB64(0x57494E5553420000llu)
#define   MS_OS_10_MBIM_COMPATIBLE_ID    HostToUSB64(0x4D42494D00000000llu)
#define   MS_OS_10_ALTRCFG_COMPATIBLE_ID HostToUSB64(0x414C545243464700llu)
#define   MS_OS_10_CDC_WMC_COMPATIBLE_ID HostToUSB64(0x4344435F574D4300llu)
#define   MS_OS_10_WMCALTR_COMPATIBLE_ID HostToUSB64(0x574D43414C545200llu)

#define   MS_OS_10_NULL_SUBCOMPATIBLE_ID HostToUSB64(0x0000000000000000llu)
#define   MS_OS_10_BT11_SUBCOMPATIBLE_ID HostToUSB64(0x3131000000000000llu)
#define   MS_OS_10_BT12_SUBCOMPATIBLE_ID HostToUSB64(0x3132000000000000llu)
#define   MS_OS_10_EDR2_SUBCOMPATIBLE_ID HostToUSB64(0x4544520000000000llu)
#define   MS_OS_10_ALT2_SUBCOMPATIBLE_ID HostToUSB64(0x3200000000000000llu)
#define   MS_OS_10_ALT3_SUBCOMPATIBLE_ID HostToUSB64(0x3300000000000000llu)
#define   MS_OS_10_ALT4_SUBCOMPATIBLE_ID HostToUSB64(0x3400000000000000llu)
